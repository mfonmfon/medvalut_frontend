 ...
 const fullAddress = '0x3F18A7B2F97DEFC2AA84A22C39F19A91C5D';
   ...
   return (
     <div className="relative w-full h-60 bg-gradient-to-r from-blue-800 via-blue-900 to-gray-900 text-white rounded-xl p-6 shadow-2xl overflow-hidden transform transition-transform">
       ...
       {/* Card Details */}
       <div className="mt-11">
         <h3 className="text-base font-semibold tracking-tight">Patient Wallet</h3>
         <p className="text-3xl font-bold mt-4">$57,00.21</p>
         ...
         <div className="flex items-center space-x-2 mb-1">
           <p className="text-sm font-mono text-blue-300 truncate max-w-[200px]">
             {showFull ? fullAddress : `${fullAddress.slice(0, 3)}......${fullAddress.slice(-3)}`}
           </p>
       ...
       {/* Action Button */}
       <button className="absolute cursor-grabbing bottom-6 right-6 bg-blue-500 bg-opacity-80 hover:bg-opacity-100 transition rounded-lg px-4 py-2 text-sm font-semibold text-white">
         View transactions
       </button>
     </div>
   );
...
export default PatientWalletCard
